...
TRAINING_TRIGGER = ["?", 
                ...
                ]  # Des expressions clés, pour faciliter l'apprentissage automatique (ppour capture_qr.json) (Vous pouvez en rajouter ou reduire)
LOG_FILE = "logs/bot.log" # (pas touche)
ALERT_CHANNEL = 1232303023955378199 # Salon d'alerte lorsque le bot capt une nouvelle information de lui-même